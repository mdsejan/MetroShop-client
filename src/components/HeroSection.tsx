...
const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-[#FCF2DB] py-32 overflow-hidden min-h-[40vh]">
      {/* Background Shapes */}
      ...
      {/* Contents */}
      <div className="container mx-auto flex flex-col items-center justify-center text-center px-4 relative z-10 min-h-[40vh]">
